...
<body align="center" style='background: linear-gradient(90deg, #4CB8C4 4%, #3CD3AD 100%);background-repeat: repeat-y';>

		<form>
		
		<img src="img/registeruser.png" height="100" width="100" align="middle"/>
